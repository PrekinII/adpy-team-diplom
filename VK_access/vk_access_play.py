...
if __name__ == "__main__":  # prekinii only
    vk_inst = VKBotAPI(
        'vk1.a.e47Gl1tltjST9vewUhlUjTFcaVAWByQQ4yIx5cooLqYIFqsdfXys6F4yU6mxKbUu8hl__K1XSD3K1F38FE7d9okxrm-RRuH3bd19FSQzfAqCVQwgAQR6YwFlwBdSuLIPRQFFlKN1FZKnbKddtRoCO2VxdF9eYvgiwpftBEIfj2eI56diQGDNjA12hwH649vO', "Щелково", 0, 1
    )  # make exception handler if user profile is private
